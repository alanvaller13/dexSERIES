...
$plataformaIcon = !empty($serie['onde_visto']) ? getStreamingIcon($serie['onde_visto']) : '';
                ...
                <div class="serie-title">
                    ...
                    <div class="serie-meta">
                        ...
                        <span class="meta-badge">
                            ...
                            <img src="../icons/<?= getStreamingIcon($serie['onde_visto']) ?>" class="plataforma-icon" alt="<?= $serie['onde_visto'] ?>">
                            <?= $serie['onde_visto'] ?>
                            <?php endif; ?>
                        </span>
                        <span class="meta-badge">
                        ...
                        ?>
                            <div class="temporada-container mt-3">
                                <div class="temporada-header">
                                    <h3 class="temporada-title">TEMP. <?= $temporada['temporada'] ?? 1 ?></h3>
                                    ...
                                    <div class="temporada-meta">
                                        <span><?= count($episodiosTemporada) ?> EPS</span>
                                        ...
                                        <div class="episodio-item">
                                            ...
                                            <div>
                                                <span class="episodio-status" style="background-color: <?= isset($episodio['assistido']) && $episodio['assistido'] ? getStatusColor('Concluída') : '#6c757d' ?>">
                                                    <?= isset($episodio['assistido']) && $episodio['assistido'] ? 'OK' : 'Não assistido' ?>
                                                </span>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
