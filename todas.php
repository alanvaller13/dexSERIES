...
$allSeries = loadJsonData('series.json');
...
$series = array_slice($allSeries, ($paginaAtual - 1) * $seriesPorPagina, $seriesPorPagina);
...
<header class="site-header">
    <div class="container">
        <div class="header-content">
            <h1 class="header-title">Todas as Séries</h1>
...
<main class="container">
    ...
    <div class="search-filters">
        ...
        <div>
            <label for="filter-user-status">Meu Status</label>
            <select id="filter-user-status" onchange="filtrarSeries()">
                <option value="all">Todos</option>
                <option value="nao-assistido">Não Assistido</option>
    ...
    <nav class="pagination">
        <ul class="pagination">
            <?php if ($paginaAtual > 1): ?>
                <li class="page-item">
                    <a class="page-link" href="?pagina=<?= $paginaAtual - 1 ?>">&laquo; Anterior</a>
                </li>
            <?php endif; ?>
            ...
            <?php if ($paginaAtual < $totalPaginas): ?>
                <li class="page-item">
                    <a class="page-link" href="?pagina=<?= $paginaAtual + 1 ?>">Próxima &raquo;</a>
                </li>
            <?php endif; ?>
        </ul>
    </nav>
